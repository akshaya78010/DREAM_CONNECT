  ...
  const fetchData = async () => {
    try {
      ...
      if (isMyProfile) {
        ...
        const iFollow = profileRes.data.followers.some(
          (f) => f._id === user?._id,
        );
      ...
      >
        {isMyProfile && (
          <button
            ...
            className={`btn ${profile.isPrivate ? "btn-secondary" : ""}`}
      ...
      >
        <button
          ...
          style={{
            ...
            border: "none",
            color:
              activeTab === "dreams" ? "var(--primary)" : "var(--text-muted)",
            fontSize: "1.2rem",
            fontWeight: 600,
            cursor: "pointer",
            paddingBottom: "0.5rem",
            borderBottom:
              activeTab === "dreams" ? "2px solid var(--primary)" : "none",
          }}
        >
          Dreams
        </button>
        <button
          ...
          style={{
            ...
            border: "none",
            color:
              activeTab === "achievements" ? "#10b981" : "var(--text-muted)",
            fontSize: "1.2rem",
            fontWeight: 600,
            cursor: "pointer",
            paddingBottom: "0.5rem",
            borderBottom:
              activeTab === "achievements" ? "2px solid #10b981" : "none",
          }}
        >
          Achievements
        </button>
